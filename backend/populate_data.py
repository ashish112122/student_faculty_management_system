"""
Populate data with exact requirements
"""
import oracledb
...
def populate():
    ...
    # Assign faculty to subjects and batches
    print("\n3. Creating faculty assignments...")
    assignment_count = 0
    
    for i, fac_id in enumerate(faculty_ids):
        subject_id = subject_ids[i]
        
        # Each faculty gets 3 batches
        if i == 0:
            assigned_batches = ['2Q31', '2Q32', '2Q33']
        elif i == 1:
            assigned_batches = ['2Q34', '2Q35', '2Q36']
        elif i == 2:
            assigned_batches = ['2Q37', '2Q38', '2Q39']
        elif i == 3:
            assigned_batches = ['2Q40', '2Q31', '2Q32']
        else:
            assigned_batches = ['2Q33', '2Q34', '2Q35']
    ...
    for idx, student_id in enumerate(student_ids):
        ...
        if (idx + 1) % 50 == 0:
            print(f"   Generated marks for {idx + 1} students...")
            conn.commit()
    ...
    # Generate attendance
    print("\n6. Generating attendance (1 Jan - 1 May 2026)...")
    attendance_count = 0
    ...
    for idx, student_id in enumerate(student_ids):
        ...
        if (idx + 1) % 50 == 0:
            print(f"   Generated attendance for {idx + 1} students...")
            conn.commit()
    ...
    print(f"\nSample Credentials:")
    print(f"  Student: rohan.sharma.2q31.0@thapar.edu / pass123")
    print(f"  Faculty: dr.rajesh@thaparfac.edu / pass123")
